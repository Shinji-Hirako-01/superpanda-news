...
{#if $page.status === 404}
	<div
		class="min-w-screen min-h-screen flex items-center p-5 lg:p-20 overflow-hidden relative dark:bg-slate-800"
	>
		<div
			class="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left dark:bg-slate-800"
		>
			<div class="w-full md:w-1/2">
              ...
              ERROR 404!
				...
				<div class="mb-10 md:mb-20 text-gray-600 font-light dark:text-white dark:bg-slate-800">
					<h1 class="font-black capitalize text-3xl lg:text-5xl text-yellow-500 mb-10">
						You seem to be lost!
					</h1>
					<p>The page you're looking for isn't available.</p>
					<p>Try searching again or go back to the home page</p>
				</div>
				<div class="mb-20 md:mb-0">
					<a
						...
						><i class="mdi mdi-arrow-left mr-2" />Home Page</a
					>
				</div>
			</div>
			<div class="w-full md:w-1/2 text-center">
				<svg
					...
					class="w-full max-w-lg lg:max-w-full mx-auto rounded"
					><style>
						.st0 {
							fill: #fff;
						}
					...
					</style><path class="st0 dark:bg-slate-8" d="M0 0h500v500H0z" id="BACKGROUND" /><g
						id="OBJECTS"
						><path
							class="st1"
