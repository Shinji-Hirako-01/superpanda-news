...
<Navbar />
{#if $page.status !== 404}
<div class="w-full dark:bg-slate-800 md:w-1/3 mx-auto">
...
<div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="Support Sp Toonz" href="https://youtube.com/@SPTOONZ" target="_blank" class="block w-10 h-10 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12 bg-slate-100">
